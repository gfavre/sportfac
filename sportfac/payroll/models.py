...
class Function(TimeStampedModel):
    ...
    rate = models.DecimalField(
        verbose_name=_("Rate"), max_digits=10, decimal_places=2, blank=True, null=True
    )
...
class Payroll(TimeStampedModel):
    ...
    include_already_exported = models.BooleanField(
        _("Include already exported sessions"), default=False
    )
