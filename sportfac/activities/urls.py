...
urlpatterns = [
    ...
    url(r"^(?P<slug>[-_\w]+)/$", view=views.ActivityDetailView.as_view(), name="activity-detail"),
    url(r"^my-courses$", view=views.MyCoursesListView.as_view(), name="my-courses"),
    url(
