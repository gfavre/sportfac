...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Responsible', fields ['first']
        db.create_index(u'activities_responsible', ['first'])

        # Adding index on 'Responsible', fields ['last']
        db.create_index(u'activities_responsible', ['last'])


    def backwards(self, orm):
        # Removing index on 'Responsible', fields ['last']
        db.delete_index(u'activities_responsible', ['last'])

        # Removing index on 'Responsible', fields ['first']
        db.delete_index(u'activities_responsible', ['first'])
