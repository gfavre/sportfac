...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtraNeed'
        db.create_table(u'activities_extraneed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extra', to=orm['activities.Activity'])),
            ('question_label', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'activities', ['ExtraNeed'])


    def backwards(self, orm):
        # Deleting model 'ExtraNeed'
        db.delete_table(u'activities_extraneed')
