...
class Teacher(TimeStampedModel):
    number = models.IntegerField(
        db_index=True, unique=True, null=True, blank=True, verbose_name=_("Number")
    )
    ...
    email = models.EmailField(
        verbose_name=_("Email address"), max_length=255, blank=True, null=True
    )
    buildings = models.ManyToManyField(
        "Building", verbose_name=_("Building"), related_name="teachers", blank=True
    )
