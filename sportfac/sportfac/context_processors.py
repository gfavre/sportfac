...
def kepchup_context(request):
    ...
    _kepchup_context_cache = {
        ...
        "COURSE_GROUPS": settings.KEPCHUP_COURSE_GROUPS,
        "DIPLOMAS": settings.KEPCHUP_DIPLOMAS,
        "PRACTICAL_REMINDER": settings.KEPCHUP_PRACTICAL_REMINDER,
        "PAPER_ATTENDANCE": settings.KEPCHUP_PAPER_ATTENDANCE,
