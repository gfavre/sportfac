...
KEPCHUP_DISPLAY_COURSE_DETAILS = False
...
KEPCHUP_AGES = list(range(4, 100))
KEPCHUP_LIMIT_BY_AGE = True
KEPCHUP_LIMIT_BY_SCHOOL_YEAR = False
...
KEPCHUP_PRICING_MODE = "family_local_3_levels"
...
KEPCHUP_DECOMPTE_SHOW_GROUP_NUMBER = False
KEPCHUP_DECOMPTE_DOWNLOAD = True
KEPCHUP_SESSION_DATES_OPTIONAL = True
KEPCHUP_AGE_OPTIONAL = True
