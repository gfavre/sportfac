...
KEPCHUP_DECOMPTE_ONLY_VALIDATED_SESSIONS = False
KEPCHUP_DECOMPTE_SHOW_GROUP_NUMBER = True
KEPCHUP_DECOMPTE_DOWNLOAD = False
KEPCHUP_SESSION_DATES_OPTIONAL = False
KEPCHUP_AGE_OPTIONAL = False
...
KEPCHUP_PRACTICAL_REMINDER = False
