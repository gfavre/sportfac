...
class UserResource(resources.ModelResource):
    ...
    home_phone = fields.Field(
        attribute="private_phone", column_name=_("Home phone"), widget=PhoneWidget()
    )
    mobile_phone = fields.Field(
        attribute="private_phone2", column_name=_("Mobile phone"), widget=PhoneWidget()
    )
    other_phone = fields.Field(
        attribute="private_phone3", column_name=_("Other phone"), widget=PhoneWidget()
    )
