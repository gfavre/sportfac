...
ALTER_USER_PERMISSIONS1 = (
    'ALTER TABLE "public"."profiles_familyuser_user_permissions" DROP COLUMN "familyuser_id";'
)
ALTER_USER_PERMISSIONS2 = (
    'ALTER TABLE "public"."profiles_familyuser_user_permissions" ADD COLUMN "familyuser_id" uuid;'
)
