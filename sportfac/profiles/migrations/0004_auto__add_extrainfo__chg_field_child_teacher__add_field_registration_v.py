...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtraInfo'
        db.create_table(u'profiles_extrainfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registration', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extra', to=orm['profiles.Registration'])),
            ('key', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.ExtraNeed'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'profiles', ['ExtraInfo'])


        # Changing field 'Child.teacher'
        db.alter_column(u'profiles_child', 'teacher_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['profiles.Teacher']))
        # Adding field 'Registration.validated'
        db.add_column(u'profiles_registration', 'validated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ExtraInfo'
        db.delete_table(u'profiles_extrainfo')


        # Changing field 'Child.teacher'
        db.alter_column(u'profiles_child', 'teacher_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Teacher']))
        # Deleting field 'Registration.validated'
        db.delete_column(u'profiles_registration', 'validated')
    ...
    models = {
        ...
        u'profiles.extrainfo': {
            ...
            'registration': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'extra'", 'to': u"orm['profiles.Registration']"}),
