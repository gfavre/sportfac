...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Registration.payed'
        db.delete_column(u'profiles_registration', 'payed')

        # Adding field 'Registration.paid'
        db.add_column(u'profiles_registration', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Registration.payed'
        db.add_column(u'profiles_registration', 'payed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Registration.paid'
        db.delete_column(u'profiles_registration', 'paid')
