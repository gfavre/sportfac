...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Registration', fields ['validated']
        db.create_index(u'profiles_registration', ['validated'])


    def backwards(self, orm):
        # Removing index on 'Registration', fields ['validated']
        db.delete_index(u'profiles_registration', ['validated'])
