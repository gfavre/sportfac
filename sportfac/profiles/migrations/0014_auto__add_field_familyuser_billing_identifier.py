...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilyUser.billing_identifier'
        db.add_column(u'profiles_familyuser', 'billing_identifier',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=45, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilyUser.billing_identifier'
        db.delete_column(u'profiles_familyuser', 'billing_identifier')
    ...
    models = {
        ...
        u'activities.course': {
            ...
            'uptodate': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        u'profiles.familyuser': {
            ...
            'billing_identifier': ('django.db.models.fields.CharField', [], {'max_length': '45', 'blank': 'True'}),
        ...
        u'profiles.schoolyear': {
            'Meta': {'ordering': "('year',)", 'object_name': 'SchoolYear'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
