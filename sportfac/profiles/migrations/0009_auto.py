...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Registration', fields ['paid']
        db.create_index(u'profiles_registration', ['paid'])


    def backwards(self, orm):
        # Removing index on 'Registration', fields ['paid']
        db.delete_index(u'profiles_registration', ['paid'])
