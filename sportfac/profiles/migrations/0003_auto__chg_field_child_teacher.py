...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Child.teacher'
        db.alter_column(u'profiles_child', 'teacher_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['profiles.Teacher']))
    ...
    models = {
        ...
        u'profiles.child': {
            ...
            'teacher': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'students'", 'null': 'True', 'to': u"orm['profiles.Teacher']"})
        },
