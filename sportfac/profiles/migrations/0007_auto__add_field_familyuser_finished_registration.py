...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilyUser.finished_registration'
        db.add_column(u'profiles_familyuser', 'finished_registration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilyUser.finished_registration'
        db.delete_column(u'profiles_familyuser', 'finished_registration')
