...
from profiles.models import FamilyUser, Child, Teacher
from activities.tests.factories import CourseFactory, YEARS
...
class ChildFactory(factory.DjangoModelFactory):
    ...
    teacher = factory.SubFactory(FamilyUserFactory)
